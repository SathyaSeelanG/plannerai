...
const ProjectWriteup: React.FC = () => {
  ...
  return (
    <div className="container mx-auto max-w-4xl py-8 px-4 text-white animate-fade-in">
      <h1 className="text-4xl font-bold text-primary mb-2">Planner AI: Capstone Project Write-up</h1>
      ...
      <div className="bg-[#111f22] p-6 rounded-lg mb-8 border border-[#325e67]">
        ...
        <p className="mb-4 text-[#92c0c9]">
          <strong>Planner AI</strong> is an intelligent application that acts as a personal curriculum designer. By simply entering a learning goal (e.g., "Learn Python for Data Science"), the application employs a multi-agent system to:
        </p>
